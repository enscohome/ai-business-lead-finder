  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <h2 className="text-xl font-semibold mt-8 mb-4">4. Subscription Plans</h2>
        <p>We offer Free, Pro, and Agency subscription plans. You may upgrade or downgrade at any time. Refunds are handled on a case-by-case basis.</p>

        <h2 className="text-xl font-semibold mt-8 mb-4">5. Acceptable Use</h2>
        <p>You agree not to use the service for spam, harassment, or any illegal activities. We reserve the right to suspend accounts violating these terms.</p>

        <h2 className="text-xl font-semibold mt-8 mb-4">6. Data Accuracy</h2>
